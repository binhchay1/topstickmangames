...
if ( ! function_exists( 'myarcade_thumbnail' ) ) {
  ...
  function myarcade_thumbnail( $args = array() ) {
    ...
    if ( $args['lazy_load'] ) {
      if ( $args['class'] ) {
        $args['class'] = 'class="background-placeholder '.$args['class'].'"';
      }
      else {
        $args['class'] = 'class="background-placeholder"';
      }
      echo '<img itemprop="image" src="'.$args['lazy_placeholder'].'" data-echo="'.$thumbnail.'" width="'.$args['width'].'" height="'.$args['height'].'" '.$args['class'].' alt="'.the_title_attribute( array( 'echo' => false ) ).'" /><noscript><img src="'.$thumbnail.'" width="'.$args['width'].'" height="'.$args['height'].'" '.$args['class'].' alt="'.the_title_attribute( array( 'echo' => false ) ).'" /></noscript>';
    }
    else {
...
if ( ! function_exists( 'myarcade_screenshot' ) ) {
  ...
  function myarcade_screenshot ( $args = array() ) {
    ...
    if ( strpos( $screenshot, 'http' ) !== false ) {
      if ( $args['lazy_load'] ) {
      $output = '<img itemprop="image" src="'.$args['lazy_placeholder'].'" data-echo="'.$screenshot.'" width="'.$args['width'].'" height="'.$args['height'].'" '.$args['class'].' alt="'.the_title_attribute( array( 'echo' => false ) ).'" /><noscript><img src="'.$screenshot.'" width="'.$args['width'].'" height="'.$args['height'].'" '.$args['class'].' alt="'.the_title_attribute( array( 'echo' => false ) ).'" /></noscript>';
      }
      else {
        ...
        <li>
          <div class="gmcn-smal-3">
            <figure class="gm-imag">
              <a href="#">
                <img src="images/cnt/game.jpg" alt="img"><span class="fa-gamepad"><?php _e("<strong>PLAY</strong> <span>NOW!</span>", 'myarcadetheme' ); ?></span>
              </a>
            </figure>
            <figure class="gm-imag">
